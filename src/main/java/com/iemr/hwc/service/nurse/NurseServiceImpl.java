...
public class NurseServiceImpl implements NurseService {
	...
	public List<BenVisitsDTO> getVisitByLocationAndLastModifDate(Integer villageID, Timestamp lastModifDate) {
		...
		System.out.println("list benvisit size "+listBenVisitFlowsOBJs.size());
...
//			if(beneficiaryFlowStatus.getVisitSession()!=null){
//				benVisitsDTO.setSessionID(Long.valueOf(beneficiaryFlowStatus.getVisitSession()+""));
//			}
