...
//        System.out.println("List listBenPhysicalVitalDetails received "+listBenPhysicalVitalDetails.size());
...
//        System.out.println("List listBenAnthropometryDetails received "+listBenAnthropometryDetails.size());
...
//                System.out.println("VisitID "+benPhysicalVitalDetail.getBenVisitID());
//                System.out.println("VisitCode "+benPhysicalVitalDetail.getVisitCode());
    ...
    public List<PastHistoryDTO> getBenMedHistoryByLocationAndLastModifDate(Integer providerServiceMapId, Integer vanID, Timestamp lastModifDate){
        ...
        System.out.println("providerServiceMapId "+providerServiceMapId);
        System.out.println("vanID "+vanID);
        System.out.println("lastModifDate "+lastModifDate);
